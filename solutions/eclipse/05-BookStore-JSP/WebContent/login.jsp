	            ...
	            <div id="wrappermiddle">
	                ...
	                <div id="username_input">
	                    ...
	                    <div id="field_inputmiddle">
	                        <input type="text" name="<%= Constants.USERNAME %>" id="url" value="<%= Constants.USERNAME %>" onclick="this.value = ''" />
	                ...
	                <div id="password_input">
	                    <div id="field_inputleft"></div>
	                    <div id="field_inputmiddle">
	                        <input type="password" name="<%= Constants.PASSWORD %>" id="url" value="<%= Constants.PASSWORD %>" onclick="this.value = ''" />
